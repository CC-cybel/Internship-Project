...
import logging
from leadbench_excellent.generation.processors import DialogueProcessor

logger = logging.getLogger(__name__)

class ResponseGenerator:
    def __init__(self, model: APIModel, processor: Optional[DialogueProcessor] = None, max_tokens: int = 2048):
        self.model = model
    ...
    def generate_response(self, sample: Dict[str, Any]) -> str:
        ...
        raw_response = self.model.chat(processed_messages, max_tokens=self.max_tokens)
