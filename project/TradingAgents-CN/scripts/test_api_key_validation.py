...
def test_api_key_validation():
    ...
    test_cases = [
        ...
        ("sk-" + "9" * 32, True, "有效的 API Key"),
        ("sk-" + "c" * 32, True, "有效的 API Key"),
        ("AI" + "za" + "A" * 35, True, "有效的 Google API Key"),
        ("bce-v3/" + "A" * 24 + "/" + "d" * 40, True, "有效的千帆 API Key"),
        ("sk-or-v1-" + "a" * 64, True, "有效的 OpenRouter API Key"),
        ("\"" + "sk-" + "9" * 32 + "\"", True, "带引号的有效 API Key"),
        ("'" + "sk-" + "9" * 32 + "'", True, "带单引号的有效 API Key"),
    ]
