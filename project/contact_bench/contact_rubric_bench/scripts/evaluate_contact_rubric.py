...
from contactbench.evaluation.rubric_scorer import (  # noqa: E402
...
DEFAULT_RUBRIC = _BENCH_ROOT / "data" / "rubrics" / "contact_rubric_v001.json"
DEFAULT_HARD_CONFIG = _BENCH_ROOT / "data" / "rules" / "contact_reward_hard_config.json"
