...
: "${DUAL_ZSCORE_ALPHA:=0.8}"
: "${DUAL_ZSCORE_OUTPUT_MODE:=raw}"
: "${DUAL_ZSCORE_TANH_SCALE:=1.0}"
: "${DUAL_ZSCORE_CLIP:=1.0}"
...
: "${EXP_NAME:=qwen3_8b_4gpu_stage4_contact_reward_dual_zscore_${RUN_TAG}}"
...
CMD=(
  "${PYTHON_BIN}" -m recipe.dual_zscore_grpo.main_ppo
  --config-name ppo_trainer
  "algorithm.adv_estimator=dual_zscore_grpo"
  "+algorithm.dual_zscore_alpha=${DUAL_ZSCORE_ALPHA}"
  "+algorithm.dual_zscore_output_mode=${DUAL_ZSCORE_OUTPUT_MODE}"
  "+algorithm.dual_zscore_tanh_scale=${DUAL_ZSCORE_TANH_SCALE}"
  "+algorithm.dual_zscore_clip=${DUAL_ZSCORE_CLIP}"
...
echo "[INFO] adv_estimator=dual_zscore_grpo, alpha=${DUAL_ZSCORE_ALPHA}, output_mode=${DUAL_ZSCORE_OUTPUT_MODE}"
