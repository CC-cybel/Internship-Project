...
: "${EXP_NAME:=qwen3_8b_4gpu_stage3_ab_reward_${RUN_TAG}}"
...
CMD=(
  ...
  "reward.custom_reward_function.path=recipe/single_turn_reward/v3/reward_function_stage3_ab_cloud.py"
...
echo "[INFO] using reward=recipe/single_turn_reward/v3/reward_function_stage3_ab_cloud.py"
