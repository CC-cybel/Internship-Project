...
: "${EXP_NAME:=qwen3_8b_4gpu_stage2_reward_${RUN_TAG}}"
...
CMD=(
  ...
  "reward.custom_reward_function.path=recipe/single_turn_reward/reward_function_stage2_cloud.py"
  ...
  "+reward.custom_reward_function.reward_kwargs.rule_weight=0.40"
  "+reward.custom_reward_function.reward_kwargs.model_weight=0.60"
  "+reward.custom_reward_function.reward_kwargs.stage_weight=0.1"
  "+reward.custom_reward_function.reward_kwargs.objective_weight=0.3"
  "+reward.custom_reward_function.reward_kwargs.professional_weight=0.3"
  "+reward.custom_reward_function.reward_kwargs.benchmark_weight=0.3"
...
echo "[INFO] using reward=recipe/single_turn_reward/reward_function_stage2_cloud.py"
echo "[INFO] rollout_n=${ROLLOUT_N}, gpu_mem=${ROLLOUT_GPU_MEMORY_UTIL}, max_num_seqs=${ROLLOUT_MAX_NUM_SEQS}"
printf ' %q' "${CMD[@]}"
echo
