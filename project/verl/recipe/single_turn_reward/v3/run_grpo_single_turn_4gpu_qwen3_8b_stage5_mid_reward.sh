...
: "${MODEL_PATH:=/data1/chengch/models/qwen3_8b_stage4_contact_reward_step300}"
: "${TRAIN_FILE:=/data/chengch/project/rl_remake/outputs/single_turn_rl_mid_stage_new_sources_10k/single_turn_rl_mid_stage_new_sources.train.parquet}"
: "${VAL_FILE:=/data/chengch/project/rl_remake/outputs/single_turn_rl_mid_stage_new_sources_10k/single_turn_rl_mid_stage_new_sources.val.parquet}"
...
: "${ROLLOUT_MAX_BATCHED_TOKENS:=4608}"
...
CMD=(
  ...
  "reward.custom_reward_function.path=recipe/single_turn_reward/v3/reward_function_stage5_mid_cloud.py"
...
echo "[INFO] using reward=recipe/single_turn_reward/v3/reward_function_stage5_mid_cloud.py"
