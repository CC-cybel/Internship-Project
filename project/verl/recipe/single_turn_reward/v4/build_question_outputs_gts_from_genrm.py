...
def normalize_question(q: str) -> str:
    # Keep logic simple and deterministic: strip only.
    return (q or "").strip()
...
def main() -> None:
    ...
    parser.add_argument(
        "--train-parquet",
        default="/data/chengch/project/rl_remake/outputs/single_turn_rl_contact_stage_20k/single_turn_rl_contact_stage.train.parquet",
    )
    parser.add_argument(
        "--genrm-jsonl",
        default="/data1/chengch/verl_outputs/grpo_single_turn/qwen3_8b_4gpu_stage4_contact_reward_20260413_095814/genrm_io.jsonl",
    )
    parser.add_argument(
        "--output-json",
        default="/data1/chengch/verl_outputs/grpo_single_turn/qwen3_8b_4gpu_stage4_contact_reward_20260413_095814/question_outputs_gts.json",
    )
    parser.add_argument(
