...
: "${TRAIN_FILE:=/data/chengch/project/rl_remake/outputs/single_turn_rl_contact_age_directed_1k_v3/single_turn_rl_contact_age_directed.all.parquet}"
: "${VAL_FILE:=/data/chengch/project/rl_remake/outputs/single_turn_rl_contact_age_directed_1k_v3/single_turn_rl_contact_age_directed.val.parquet}"
...
: "${RESUME_FROM_PATH:=/data1/chengch/verl_outputs/grpo_single_turn/qwen3_8b_4gpu_stage4_contact_reward_20260506_172744/global_step_50}"
...
CMD=(
  ...
  "reward.custom_reward_function.path=recipe/single_turn_reward/v4/reward_function_stage4_contact_cloud.py"
...
echo "[INFO] using reward=recipe/single_turn_reward/v4/reward_function_stage4_contact_cloud.py"
