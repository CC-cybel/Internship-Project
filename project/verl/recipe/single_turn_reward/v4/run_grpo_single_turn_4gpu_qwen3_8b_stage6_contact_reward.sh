...
# Stage 6 - Contact Stage: 留联阶段训练（分龄定向留联）
: "${MODEL_PATH:=/data1/chengch/models/qwen3_8b_mid_short_step350}"
: "${TRAIN_FILE:=/data/chengch/project/rl_remake/outputs/single_turn_rl_contact_stage_2k_qwen3_8b_normal_mid_short_step350/single_turn_rl_contact_stage.train.parquet}"
: "${VAL_FILE:=/data/chengch/project/rl_remake/outputs/single_turn_rl_contact_stage_2k/single_turn_rl_contact_stage.val.parquet}"
...
: "${EXP_NAME:=qwen3_8b_4gpu_stage6_contact_reward_${RUN_TAG}}"
...
CMD=(
  ...
  "reward.custom_reward_function.path=recipe/single_turn_reward/v6/reward_function_stage6_contact.py"
...
echo "[INFO] using reward=recipe/single_turn_reward/v6/reward_function_stage6_contact.py"
