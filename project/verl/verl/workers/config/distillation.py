...
__all__ = [
    ...
    "DistillationTeacherRouteConfig",
    "DistillationConfig",
]
...
@dataclass
class DistillationTeacherRouteConfig(BaseConfig):
    """A named teacher model route for multi-teacher distillation."""
...
class DistillationConfig(BaseConfig):
    ...
    teacher_routes: Optional[list[DistillationTeacherRouteConfig]] = None
